...
import 'package:toy_world/apis/gets/get_follower_account.dart';
...
class _FollowerPageState extends State<FollowerPage> {
  ...
  getData() async {
    FollowerAccountList accounts = FollowerAccountList();
    data = await accounts.getFollowerAccount(
